...
@Component({
  selector: 'app-class-advisor-dashboard',
  standalone: true, // Ensure this is explicitly defined
  imports: [
    CommonModule, 
    RouterModule, 
    MatToolbarModule, 
  ...
  templateUrl: './class-advisor-dashboard.component.html',
  styleUrls: ['./class-advisor-dashboard.component.css'] // Fixed incorrect property name
})
export class ClassAdvisorDashboardComponent {
  isSidebarOpen = false;
